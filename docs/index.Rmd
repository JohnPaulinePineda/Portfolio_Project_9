...
|
| **[B]** The model contains 2 hyperparameters:
|      **[B.1]** <span style="color: #FF0000">nprune</span> = number of terms made to vary across a range of values equal to 5 to 20
|      **[B.2]** <span style="color: #FF0000">degree</span> = product degree made to vary across a range of values equal to 1 to 5
|
| **[C]** The cross-validated model performance of the final model is summarized as follows:
